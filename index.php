...
<body class="bg-white dark:bg-gray-900">
	...
	<section class="bg-gray-50 dark:bg-gray-900">
		...
		<div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
			...
			<div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-900 dark:border-gray-800" style="margin-top: 2%; box-shadow: 0 15px 20px 0; border-radius: 20px;">
